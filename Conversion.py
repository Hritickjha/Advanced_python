...
decimal_to_binary_buttom = tk.Button(menu_frame,
                            text="Decimal to Binary",command= decimal_to_binary)
decimal_to_binary_buttom.pack(side=tk.LEFT)

binary_to_decimal_button= tk.Button(menu_frame,
    text="Binary to Decimal",command=binary_to_decimal)
...
convert_button = tk.Button(root,text="convert",
                command=lambda:None) # placeholder for now
convert_button.pack()
